...
class DatasetFormatModel(Base):
    ...
    product_base_info_rows = relationship(
        "ProductBaseInfoModel", back_populates="data_format", lazy="select"
    )
    pass
...
class DatasetTypeModel(Base):
    ...
    product_base_info_rows = relationship(
        "ProductBaseInfoModel", back_populates="data_type", lazy="select"
    )
    pass
...
class UploadStatusModel(Base):
    ...
    product_base_info_rows = relationship(
        "ProductBaseInfoModel", back_populates="upload_status", lazy="select"
    )
    pass
...
class ContractModel(Base):
    ...
    product_base_info_row = relationship(
        "ProductBaseInfoModel", back_populates="contract", lazy="select"
    )
...
class ProductRegistrationModel(Base):
    ...
    product_base_info_id = Column(BIGINT, ForeignKey("product_base_info.id"))
    product_base_info_row = relationship(
        "ProductBaseInfoModel",
        back_populates="product_registration_rows",
        lazy="select",
    )
...
class GeneratingSyntheticTasksModel(Base):
    ...
    premium_purchase_id = Column(BIGINT, ForeignKey("purchase.id"))
    premium_purchase_row = relationship(
        "PurchaseModel", back_populates="synthetic_task_rows", lazy="select"
    )
    pass
...
class ProductWarehouseModel(Base):
    ...
    azoo_product = relationship(
        "AzooProductModel",
        back_populates="product_warehouse_rows",
    ...
    sampling_row = relationship(
        "SamplingModel",
        back_populates="product_warehouse_row",
        foreign_keys=[sampling_id],
        lazy="select",
    )

    purchase_id = Column(BIGINT, ForeignKey("purchase.id"))
    purchase_row = relationship(
        "PurchaseModel",
        back_populates="product_warehouse_rows",
...
class AzooProductModel(Base):
    ...
    dataset_product_order_row = relationship(
        "OrderModel",
        back_populates="dataset_azoo_product",
        foreign_keys="OrderModel.dataset_product_id",
        lazy="select",
    )
    report_product_order_row = relationship(
        "OrderModel",
        back_populates="report_azoo_product",
        foreign_keys="OrderModel.report_product_id",
        lazy="select",
    )
    pass
...
class OrderModel(Base):
    ...
    purchase_rows = relationship(
        "PurchaseModel", back_populates="order_row", lazy="select"
    )

    dataset_product_id = Column(BIGINT, ForeignKey("azoo_product.id"))
    dataset_azoo_product = relationship(
        "AzooProductModel",
        back_populates="dataset_product_order_row",
        foreign_keys=[dataset_product_id],
        lazy="select",
    )

    report_product_id = Column(BIGINT, ForeignKey("azoo_product.id"))
    report_azoo_product = relationship(
        "AzooProductModel",
        back_populates="report_product_order_row",
        foreign_keys=[report_product_id],
        lazy="select",
    )
    pass
...
class PurchaseModel(Base):
    ...
    order_row = relationship(
        "OrderModel",
        back_populates="purchase_rows",
        foreign_keys=[order_id],
        lazy="select",
    )

    product_warehouse_rows = relationship(
        "ProductWarehouseModel", back_populates="purchase_row", lazy="select"
    )
    synthetic_task_rows = relationship(
        "GeneratingSyntheticTasksModel",
        back_populates="premium_purchase_row",
        lazy="select",
    )
    pass
...
MProductTypeModel = Base.classes.m_product_type
ProjectModel = Base.classes.projects
UserModel = Base.classes.user
ProductRelationshipModel = Base.classes.product_relationship
